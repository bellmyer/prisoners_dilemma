...
Use the PD class directly to gain more control over your play. This is the class that will pit a player
against an opponent. The PD class has a _::run_ method which streamlines play. It accepts two arguments - 
an array of two player classes, and a hash of options.
